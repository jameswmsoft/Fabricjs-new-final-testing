  ...
  _chnage_dynamic_more_options:function(){
    if($('.dynamic-text-more-option').length>0 || $('.dynamic-img-more-option').length>0){
      $('.dynamic-text-more-option ul li, .dynamic-img-more-option ul li').click(function(){
        if(selectedObj && (selectedObj.itemName === 'normal_text' || selectedObj.itemName === 'normal_zone_text' || selectedObj.itemName === 'curvedText' || selectedObj.itemName === 'gallery_image' || selectedObj.itemName === 'upload_image' || selectedObj.itemName === 'shape' || selectedObj.itemName === 'placeholder')){
