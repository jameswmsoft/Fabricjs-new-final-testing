...
shopist.pageLoad =
{
  ...
  if($('#water_mark_image_uploader').length>0)
  {
    Dropzone.autoDiscover = false;
    $("#water_mark_image_uploader").dropzone({ 
      url: $('#hf_base_url').val() + "/ajax/water_mark_image_upload",
      paramName: "watermark_image", 
      acceptedFiles:  "image/*", 
      ...
      init: function() 
      {
        ...
        this.on("success", function(file, responseText) 
        {
          ...
          {
            $('#water_mark_image_url').val( $('#hf_base_url').val() + '/public/uploads/'+ responseText.name );
            $('#watermarkImageUpload').modal('hide');
            this.removeAllFiles();
          }
        });
      }
