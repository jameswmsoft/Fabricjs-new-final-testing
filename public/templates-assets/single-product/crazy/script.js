...
$("#product_image_zoom").elevateZoom({gallery:'product_gallery_image', tintColour:'#F90', tintOpacity:0.5, cursor: 'pointer', galleryActiveClass: "active", 
  //Joseph start
 // imageCrossfade: false,
  constrainType:"width", constrainSize: 20, 
   zoomType       : "lens",
   containLensZoom: false,
  //Joseph End
   loadingIcon: "images/ajax-loader-for-list-delete.gif"}); 
