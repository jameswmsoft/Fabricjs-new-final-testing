...
$("#product_image_zoom").elevateZoom({gallery:'product_gallery_image', tint:true, responsive:true, tintColour:'#F90', tintOpacity:0.5, cursor: 'pointer', galleryActiveClass: "active", 
  //Joseph start
