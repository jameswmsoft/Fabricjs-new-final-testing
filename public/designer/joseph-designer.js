    ...
    if(designerCanvasObj !== undefined) {
            ...
            designerCanvasObj.forEachObject(function(obj) {
              var distX = Math.abs(p.x - obj.left),
                ...
                if(obj !== activeObj && obj !== overlayImageBg) {
                  console.log(designerCanvasObj.getObjects().indexOf(obj), obj)
                  fadedObjects[designerCanvasObj.getObjects().indexOf(obj) - 1] =obj;
      ...
      designerCanvasObj.on('mouse:out', function(options) {
        ...
        designerCanvasObj.forEachObject(function(obj) {    
             ...
             if(fadedObjects[designerCanvasObj.getObjects().indexOf(obj) - 1] !== undefined) {
                // console.log(obj, fadedObjects[designerCanvasObj.getObjects().indexOf(obj) - 1])

                // designerCanvasObj.remove(fadedObjects[designerCanvasObj.getObjects().indexOf(obj) - 1]);

                // designerCanvasObj.add(fadedObjects[designerCanvasObj.getObjects().indexOf(obj) - 1]);
        ...
        if(fadedObjects[0] !== undefined) {
          // designerCanvasObj.add(fadedObjects[0]);
        }
