...
Route::post('/upload/designer-images-user-upload', [
    'uses' => 'Common\CommonAjaxController@uploadZoneDesignerImage',
    'as'   => 'upload-zone-designer-images'
]);
...
Route::get('/ajax/force_designer_img_download', [
  'uses' => 'Frontend\FrontendAjaxController@forceDesignerImageFile',
  'as'   => 'force-designer-img'
]);

Route::post('/ajax/water_mark_image_upload', [
  'uses' => 'Admin\AdminAjaxController@addWaterMarkImage',
  'as'   => 'water-mark-image'
]);
...
Route::post('/ajax/save_custom_design_for_watermark', [
  'uses' => 'Frontend\FrontendAjaxController@saveCustomDesignImageForWatermark',
  'as'   => 'save-custom-design-image-watermark'
]);
...
//csv import page
Route::get('/csv-import-old', function () {
    return view('csv-import-old');
});

//csv import page
Route::get('/csv-import', 'ImportController@getImport')->name('import');
Route::post('/import_parse', 'ImportController@parseImport')->name('import_parse');
Route::post('/import_process', 'ImportController@processImport')->name('import_process');

//USPS
Route::get('/usps', function () {
  return view('frontend/usps');
});


Route::get('/test','USPSController@index');
