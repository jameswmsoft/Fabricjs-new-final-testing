      ...
      <div class="canvas-container-main">
        <ul class="nav-design-element">
          <?php if(Request::is('admin/product/update/*')): ?>
            ...
            <li data-tab_name="text_zone" data-toggle="tooltip" data-placement="bottom" title="ADD text zone"><span class="icon-img-text"></span></li>
            ...
            <li data-tab_name="image_upload_back" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('frontend.upload_image')); ?>"><span class="icon-img-upload"></span></li>
            <li data-tab_name="image_zone_upload" data-toggle="tooltip" data-placement="bottom" title="Upload Zone"><span class="icon-img-upload"></span></li>
        ...
        <div class="canvas-design-panel">
          ...
          <div class="designer-upload-back-image panel panel-default">
            <div class="panel-heading" id="draggable-handle">
              <?php echo e(trans('frontend.upload_your_images')); ?>
            ...
            <div class="panel-body">
              <p class="no-margin"><?php echo e(trans('frontend.you_can_upload_1_image')); ?></p>
              <div class="dropzone dz-clickable" id="file_upload_back_for_designer" name="file_upload_back_for_designer">
                <div class="dz-default dz-message">
                  <span><?php echo e(trans('frontend.drop_your_cover_picture_here')); ?></span>
                </div>
              </div>
              <div class="recently-uploaded-back-images">
                <br>
                <?php if( count(get_recent_uploaded_images_for_designer())>0 ): ?>
                  <?php $__currentLoopData = get_recent_uploaded_images_for_designer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="recent-images-back-items"><img src="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($data); ?>"></div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <div class="clear_both"></div>
                <?php else: ?>
                  <div class="no-available-msg"><?php echo e(trans('frontend.no_recently_uploaded_images_yet')); ?></div>
          ...
          <div class="designer-upload-zone-image panel panel-default">
            <div class="panel-heading" id="draggable-handle">
              UPLOAD YOUR IMAGE ZONE
              <i class="fa fa-close pull-right close-design-control-modal" data-name="upload"></i>
            </div>
            <div class="panel-body">
              <p class="no-margin"><?php echo e(trans('frontend.you_can_upload_1_image')); ?></p>
              <div class="dropzone dz-clickable" id="file_upload_zone_for_designer" name="file_upload_zone_for_designer">
                <div class="dz-default dz-message">
                  <span><?php echo e(trans('frontend.drop_your_cover_picture_here')); ?></span>
                </div>
              </div>
              <div class="recently-uploaded-zone-images">
                <br>
                <?php if( count(get_recent_uploaded_images_for_designer())>0 ): ?>
                  <?php $__currentLoopData = get_recent_uploaded_images_for_designer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="recent-images-zone-items"><img src="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($data); ?>"></div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <div class="clear_both"></div>
                <?php else: ?>
                  <div class="no-available-msg"><?php echo e(trans('frontend.no_recently_uploaded_images_yet')); ?></div>
