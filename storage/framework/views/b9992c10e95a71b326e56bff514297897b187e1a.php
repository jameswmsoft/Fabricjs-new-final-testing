...
<body>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <p class="no-margin"><?php echo e(trans('frontend.all_design_images')); ?></p>
            </div>
  ...
  <input type="hidden" name="frontend_all_msg_with_localization" id="frontend_all_msg_with_localization" value="<?php echo e($frontend_js_localization); ?>">  
