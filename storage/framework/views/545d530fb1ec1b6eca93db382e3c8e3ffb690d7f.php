    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 footer-text">
          <div><span><?php echo trans('frontend.footer_msg', ['title' => get_site_title()]); ?></span><span class="powered-text"><?php echo trans('frontend.footer_powered_by'); ?> <strong><?php echo get_site_title(); ?></strong></span></div>
        </div>
      </div>
    </div>
  </div>  
