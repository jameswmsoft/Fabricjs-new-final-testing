      ...
      @if($products->Pfb == '0')
        ...
        <div class="col-xs-12 col-sm-4 col-md-6 extra-padding grid-view">
          <div class="hover-product">
            ...
            <a href="{{ route('details-page', $products->slug) }}" class="product-box-details"><h3>{!! $products->title !!}</h3></a>

              @if( $products->type == 'simple_product' )
              <a href="{{ route('details-page', $products->slug) }}" class="product-box-details"><p>{!! price_html( $products->price, get_frontend_selected_currency() ) !!}</p></a>
