...
<script type="text/javascript" src="{{ URL::asset('public/designer/fabric.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('public/designer/customiseControls.js') }}"></script>
...
<!-- Added by Joseph -->
<script type="text/javascript" src="{{ URL::asset('public/plugins/focus-element-overlay/focus-element-overlay.js') }}"></script>
