...
<!--                <div><input type="number" id="custom_option_dpi" class="form-control" placeholder="{{ trans('admin.export_output_custom_option_dpi_label') }}" min="1" value="300"><i>{!! trans('admin.export_output_custom_option_dpi_label') !!}</i></div>-->
              </div>
            </div>
            <div class="form-group">
