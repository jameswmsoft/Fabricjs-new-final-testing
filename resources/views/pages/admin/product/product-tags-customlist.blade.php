...
@section('title', trans('admin.product_tags_customlist') .' < '. get_site_title())
...
<div class="box box-info">
  <div class="box-header">
    ...
    <div class="box-tools pull-right">
      <button data-toggle="modal" data-target="#addDynamicTags" class="btn btn-primary custom-event-tags" type="button">{!! trans('Add New CustomTag') !!}</button>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog add-tag-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p class="no-margin top-title-tag"><b>{!! trans('Create New Product CustomTag') !!}</b></p>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default attachtopost create-tag">{!! trans('Create CustomTag') !!}</button>
