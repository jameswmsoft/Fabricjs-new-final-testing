...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">{!! trans('admin.add_new_page_top_title') !!} &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.all_pages') }}">{!! trans('admin.all_pages_list') !!}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.add_page') }}">{{ trans('admin.add_new_page_top_title') }}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" target="_blank" href="{{ route('custom-page-content', $page_data_by_slug['post_slug']) }}">{{ trans('admin.view') }}</a></h3>
