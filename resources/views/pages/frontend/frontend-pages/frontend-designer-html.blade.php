  ...
  <div class="product-designer-top-menu">
    <div class="clearfix">
      ...
      <ul class="pull-right">
        ...
        <li><a id="downloadImgLink" href="#" ><span class="fa fa-download icon-span"></span><span class="text-span">{!! trans('designer.download_label') !!}</span></a></li>
  ...
  <div class="product-designer-canvas-content-main">
    ...
    <div class="product-designer-swap-content">
      <ul class="">
        ...
        <li <?php if($count == 0) {?> class="selected-swap"<?php }?> data-id="{{ $row->id }}" data-design_img_url="{{ get_image_url($row->design_img_url) }}" data-design_trans_img_url="{{ get_image_url($row->design_trans_img_url) }}"><img src="{{ get_image_url($row->design_title_icon) }}"><span>{!! $row->title_label !!}</span><input type="hidden" name="hf_design_save_json_data_{{$row->id}}" id="hf_design_save_json_data_{{$row->id}}" value="{{ $design_save_data }}"></li>
        ...
        <li <?php if($count == 0) {?> class="selected-swap"<?php }?> data-id="{{ $row->id }}" data-design_img_url="{{ get_image_url($row->design_img_url) }}" data-design_trans_img_url="{{ get_image_url($row->design_trans_img_url) }}"><img src="{{ get_image_url($row->design_title_icon) }}"><span>{!! $row->title_label !!}</span> <input type="hidden" name="hf_design_save_json_data_{{$row->id}}" id="hf_design_save_json_data_{{$row->id}}" value="{{ $design_save_databackside }}"></li>
...
<input type="hidden" name="download_img_file_url" id="download_img_file_url" value="{{ route('force-designer-img') }}">
