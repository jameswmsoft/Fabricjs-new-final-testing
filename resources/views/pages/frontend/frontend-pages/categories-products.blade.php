        ...
        <div class="col-xs-12 col-sm-6 col-md-6 extra-padding">
          <div class="hover-product">
            ...
            <div class="single-product-bottom-section">
              ...
              <a href="{{ route('details-page', $products['slug']) }}" class="product-box-details"><h3>{!! get_product_title($products['id']) !!}</h3></a>
              @if(get_product_type($products['id']) == 'simple_product')
              <a href="{{ route('details-page', $products['slug']) }}" class="product-box-details"><p>{!! price_html( get_product_price($products['id']), get_frontend_selected_currency() ) !!}</p></a>
              @elseif(get_product_type($products['id']) == 'configurable_product')
              <a href="{{ route('details-page', $products['slug']) }}" class="product-box-details"><p>{!! get_product_variations_min_to_max_price_html(get_frontend_selected_currency(), $products['id']) !!}</p></a>
