      ...
      <div class="canvas-container-main">
        <ul class="nav-design-element">
          @if(Request::is('admin/product/update/*'))
            ...
            <li data-tab_name="image_upload_back" data-toggle="tooltip" data-placement="bottom" title="{{ trans('frontend.upload_image') }}"><span class="icon-img-upload"></span></li>
          ...
          <div class="designer-upload-back-image panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="recently-uploaded-back-images">
                ...
                @if( count(get_recent_uploaded_images_for_designer())>0 )
                  @foreach(get_recent_uploaded_images_for_designer() as $data)
                    <div class="recent-images-back-items"><img src="{{ url('/') }}/public/uploads/{{ $data }}"></div>
                  @endforeach
                  <div class="clear_both"></div>
                @else
                  <div class="no-available-msg">{{ trans('frontend.no_recently_uploaded_images_yet') }}</div>
          ...
          <div class="designer-upload-zone-image panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="recently-uploaded-zone-images">
                ...
                @if( count(get_recent_uploaded_images_for_designer())>0 )
                  @foreach(get_recent_uploaded_images_for_designer() as $data)
                    <div class="recent-images-zone-items"><img src="{{ url('/') }}/public/uploads/{{ $data }}"></div>
                  @endforeach
                  <div class="clear_both"></div>
                @else
                  <div class="no-available-msg">{{ trans('frontend.no_recently_uploaded_images_yet') }}</div>
