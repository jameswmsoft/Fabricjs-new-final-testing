                    ...
                    @if($numb == 1)
                      ...
                      <div class="product-content">
                        <div class="image-content">
                          ...
                          <img class="img-responsive" src="{{ get_image_url( $row['post_image_url'] ) }}" alt="{{ basename( get_image_url( $row['post_image_url'] ) ) }}" />
                          @else
          ...
          <div class="advertisement-right">
            <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                ...
                <div class="item">
                  <div class="text-center">
                    <a href=""><img src="{{ asset('public/images/add-sample/sunglass.png') }}" alt="" class="img-responsive" /></a>
                  </div>
                </div> 
                <div class="item">
                  <div class="text-center">
                    <a href=""><img src="{{ asset('public/images/add-sample/mobile.png') }}" alt="" class="img-responsive" /></a>
                  </div>
                </div>
              </div>
              <div class="slider-control-main text-center">
