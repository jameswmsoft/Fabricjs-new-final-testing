                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('import_process') }}">
                            ...
                            <button type="submit" class="btn btn-sm btn-style" style="background-color: #e0395d;border-color: transparent;color: #fff;font-size: 20px;font-family: &quot;Lato&quot;,sans-serif;">
                                Import Data
                            </button>
                        </form>
                    </div>
