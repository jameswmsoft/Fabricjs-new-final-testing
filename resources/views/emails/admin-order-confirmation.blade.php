                                ...
                                <tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding:36px 40px;display:block;">
                                                            ...
                                                            <div style="text-align:center;margin-top: 30px;"><h1 style="color:#ffffff;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;">{!! trans('New Order in Jacks Designer') !!}</h1></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                      <td style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;text-align:left;padding:20px 30px;"> 
                                        <p style="margin:0 0 16px">{!! trans('New Order in Jacks Designer') !!}</p><br>
